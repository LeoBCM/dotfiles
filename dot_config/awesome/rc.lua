...
-- {{{ Wibar
-- Create a textclock widget, with calendar on click
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey }, "q",      function (c) c:kill()                         end,
              {description = "close window in focus", group = "client"}),
...
awful.spawn.with_shell("pgrep xscreensaver || xscreensaver --no-splash")
